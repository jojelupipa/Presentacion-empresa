...
%% Título y otros %%
\title[Johnson \& Johnson]{Exposición sobre Johnson \& Johnson (J\&J) y su unidad estratégica} % The short title appears at the bottom of every slide, the full title is only on the title page

\author[Óscar Bermúdez, Jesús Sánchez de Lechina]{
...
\section{Campo de actividad y unidades estratégicas de negocios}
	...
	\only<1>{\begin{figure}
			\includegraphics[width=8cm]{logo.png}  %// Diapositiva 2: Una imagen del logo de JNJ con flechitas de los productos que ofrece 
		\end{figure}}
